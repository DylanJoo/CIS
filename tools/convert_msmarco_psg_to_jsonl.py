...
#
####################################################################################
# souce: github.com/castorini/anserini-tools/scripts/msmarco/convert_collection_to_jsonl.py
####################################################################################
    ...
    with open(args.collection_path, encoding='utf-8') as f:
        for i, line in enumerate(f):
            ...
            if i % args.max_docs_per_file == 0:
                ...
                output_path = os.path.join(args.output_folder, 'MARCO_PSG{:02d}.json'.format(file_index))
                output_jsonl_file = open(output_path, 'w', encoding='utf-8', newline='\n')
                file_index += 1
            output_dict = {'id': f'MARCO_{doc_id}', 'contents': doc_text}
