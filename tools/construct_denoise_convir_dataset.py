...
parser.add_argument("--run_teacher", default="spr/runs/train.canard.answer.top200.trec", type=str)
parser.add_argument("--run_student", default="spr/runs/train.canard.rewrite.top200.trec", type=str)
parser.add_argument("--output", default="convir_data/canard_convir.train.cqe.jsonl", type=str)
